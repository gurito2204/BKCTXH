...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      // 2. Update Firebase profile to include the user's name
      await updateProfile(userCredential.user, {
        displayName: name,
      });

      // 3. Successful signup, redirect and display message
      // The onAuthStateChanged listener in AuthProvider will handle creating the user in the database.
      ...
      Swal.fire({
        icon: "error",
        title: "Signup Error",
        text: errorMessage, // Display actual error message
      });
    }
  };
