            ...
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 p-8 relative" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-6">
                    <div>
                        ...
                        <p><span className="font-bold">Địa điểm:</span> {job.jobLocation}</p>
                        <p><span className="font-bold">Ngày hoạt động:</span> {new Date(job.postingDate).toLocaleDateString()}</p>
